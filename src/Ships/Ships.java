...
public class Ships {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException{
        ...
        int event,profile = 0,eventAfterLog;
        boolean isEqualLogin = false, isEqualPass = false;
        Scanner LogIn,Password,readChoice,inLogin,inPassword,read,inputLogin,inputPassword,readChoiceAfterLog;
        ...
        switch(event){
            ...
            case 2 : //Logowanie
                ...
                if(isEqualLogin == true && isEqualPass == true) // zaczyna się gra
                {
                    System.out.println("Zalogowanie przebiegło pomyślnie ! \n");
                    
                    System.out.println("MENU");
                    System.out.println(" 1 - Nowa gra ");
                    System.out.println(" 2 - Wróć do gry ");
                    System.out.println(" 3 - Obejrzyj poprzednie gry ");
                    System.out.println(" 4 - Profil uzytkownika ");
                    
                    readChoiceAfterLog = new Scanner(System.in);
                    System.out.println("\nWybierz opcję : ");
                    eventAfterLog = readChoiceAfterLog.nextInt();
                    
                    switch(eventAfterLog){
                        case 1 : 
                        ...
                        case 4 : 
                            ...
                            System.out.println("Zmiana danych logowania - wcisnij 5");
                            System.out.println("Statystyki - wcisnij 6");
